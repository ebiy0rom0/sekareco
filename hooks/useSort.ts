...
const depthSort = <T, U extends Keys<T>>(p1: T, p2: T, opts: [U, unknown][], depth: number): number => {
...
const sort = <T, U extends Keys<T>, W extends Keys<T[U]>>(p1: T, p2: T, key: U, asc: unknown): number => {
