    ...
    <>
      ...
      <div
        className={`sticky top-0 z-20 w-full flex-none border-b ${
          dark ? "border-slate-200/40" : "border-slate-400/30"
        } backdrop-blur-md`}
      >
      ...
      <div className="max-w-[100rem] mx-auto py-8">
        <div
          className={`
            ...
            hidden
            2xl:block
            border-l ${dark ? "border-slate-200/40" : "border-slate-400/30"}
          `}
        >
          <Navigation />
        </div>
        <div className="2xl:mr-[15rem] px-2 lg:px-15 2xl:px-8 items-center">
          ...
          <div
            className={`
              border-t ${dark ? "border-slate-200/40" : "border-slate-400/30"}
